...
<asp:Content ID="JavascriptContent" ContentPlaceHolderID="jscript" runat="server">
    ...
    <%: Scripts.Render("~/Scripts/PageScripts/constants.js") %>
    <%: Scripts.Render("~/Scripts/PageScripts/E911JS.new.js") %>
</asp:Content>
            ...
            <table>
                <tr>
                    <td class="tooltip">County <img src="/Images/BlackLine.png"/>
                        <div><ul>
                            <li><label for="CountyPolyShowHideMap" class="checkbox"><input type="checkbox" id="CountyPolyShowHideMap" checked />Shape</label></li>
                            <li><label for="CountyLabelShowHideMap" class="checkbox"><input type="checkbox" id="CountyLabelShowHideMap" checked />Label</label></li>
                        </ul></div>
                    </td>
                    <td class="tooltip">Rate Center <img src="/Images/RedLine.png"/>
                        <div><ul>
                            <li><label for="RateCenterPolyShowHideMap" class="checkbox"><input type="checkbox" id="RateCenterPolyShowHideMap" checked />Shape</label></li>
                            <li><label for="RateCenterLabelShowHideMap" class="checkbox"><input type="checkbox" id="RateCenterLabelShowHideMap" checked />Label</label></li>
                        </ul></div>
                    </td>
                    <td><input type="checkbox" id="PsapPolyShowHideMap" checked /><label for="PsapPolyShowHideMap" class="checkbox">PSAP <img src="/Images/BlueLine.png"/></label></td>
                    <td><input type="checkbox" id="LataPolyShowHideMap" /><label for="LataPolyShowHideMap" class="checkbox">LATA <img src="/Images/PinkLine.png"/></label></td>
                </tr>
            </table>
        </div>
                ...
                <div id="searchCriteria" class="content">
                    ...
                    <div id="searchMethods">
                        ...
                        <div id="latLngSearchDiv" style="display:none; opacity: 0; position:relative;">
                            <input id="lat-input" class="controls" type="text" placeholder="Latitude" autocomplete="off" style="z-index: 0; max-width: 80px" />
                            <input id="lng-input" class="controls" type="text" placeholder="Longitude" autocomplete="off" style="z-index: 0; max-width: 80px" />
